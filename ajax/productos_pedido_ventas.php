...
if($action == 'ajax'){
    ...
    include 'paginacion_ventas.php';//include paginacion *******************
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover">
                ...
                <tr>
                    ...
                    <td class="col-xs-2">
                        <div class="pull-right">
                            <select class="form-select" aria-label="Default select example" id="iva" name="iva" title="Seleccione el Porcentaje de la venta">
                    ...
                    <td>
                        <!-- <span class="pull-right" title="Agregar a la tablas">
                        ...
                        <span class="pull-right" title="Agregar a la tablas">
                            <!-- <a href="#" onclick="agregar('<?php echo $id_producto; ?>')"> -->
                                <button type="button" class="btn btn-block btn-success" href="#" onclick="mensaje_agregar(); agregar('<?php echo $id_producto; ?>')">
                                    Agregar
                                </button>
                            <!-- </a> -->
                        </span>
                ...
                <tr>
                    ...
                    <?php echo paginate_ventas($reload, $page, $total_pages, $adjacents);?>
                    </span></td>
                </tr>
            </table>
        </div>
