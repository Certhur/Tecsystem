...
if(empty($_SESSION["username"]) && empty($_SESSION["password"])){
    ...
    elseif($_GET["act"]=="update"){
        if(isset($_POST["Guardar"])){
            if(isset($_POST["codigo"])){
                ...
                id_departamento = $departamento WHERE cod_ciudad = $codigo;")or die('Error'.mysqli_error($mysqli));
                if($query){
    ...
    elseif($_GET["act"]=="delete"){
        if(isset($_GET["cod_ciudad"])){
            ...
            $query = mysqli_query($mysqli, "DELETE FROM ciudad WHERE cod_ciudad = $codigo;")or die('Error'.mysqli_error($mysqli));
            if($query){
